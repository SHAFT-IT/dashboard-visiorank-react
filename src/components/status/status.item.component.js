...
const getIconName = (statusId) => {
  switch(statusId) {
    case 1: return 'forward'     // STATUT_BROUILLON_KEY
    case 2: return 'pencil'      // STATUT_PRISE_EN_CHARGE_KEY
    case 3: return 'thumbs-down' // STATUT_REFUSE_KEY
    case 4: return 'check'       // STATUT_LIVRE_KEY
    case 5: return 'thumbs-up'   // STATUT_VALIDE_KEY
    case 6: return 'close'       // STATUT_CLOS_KEY
  }
}
