...
import { updateDemand, updateDemandReset } from '../../../store/actions/demands.update.action';
...
const tabsDemande = (pageType, demand, updateDemands, updateUi, detailResponse) => createBottomTabNavigator(
  {
    DemandeCreateTab: {
      screen: props => <DemandCreateContainer {...props} pageType={pageType} demand={demand}
                                              updateDemands={updateDemands} updateUi={updateUi}
