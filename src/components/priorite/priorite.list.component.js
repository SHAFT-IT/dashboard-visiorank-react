    ...
    render() {
        ...
        return (
            <View style={{width: 300, height: 'auto', borderRadius: 5, paddingVertical: 5,  backgroundColor:'#fff'}}>
                <View>
                    <Text style={{fontWeight: 'bold', textAlign:'center', margin:20}}>Modification de la priorité de la demande</Text>
                    <Text style={{fontWeight: 'bold', textAlign:'center'}}>Priorité actuelle : {current.priorite_libelle}</Text>
