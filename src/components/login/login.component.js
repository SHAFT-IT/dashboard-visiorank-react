...
import { Dimensions, ScrollView, StyleSheet, Text, TextInput, TouchableHighlight, View } from 'react-native';
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.wrapper}>
          <View style={styles.iconTop}>
            <AutoHeightImage source={require('../../assets/images/logo_login.png')} width={200}/>
          </View>
